...
class Validation:
    ...
    def recompile(self, property_tag_name:str, version: str):
        ...
        command = f"cd {self.path_to_cloned_folder} && mvn -Dmaven.test.skip=true -Dcheckstyle.skip=true -Denforcer.skip=true -D{property_tag_name}={version}  -pl {self.relative_path_to_module} compile -am"
        try:
